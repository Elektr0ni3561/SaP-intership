...
if __name__ == "__main__":
    ...
    #Предполагаю, что числа, у которых дробная часть не равна 0, не следует округлять до целого.
    print(max_odd([21.0, 2, 3, 4, 4]))  # => 21
    #В задании говорится только об элементах исходного списка, поэтому предполагаю, что не надо рекурсивно проверять вложенные списки.
